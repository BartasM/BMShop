...
public class ProductConfig {
    ...
    CommandLineRunner commandLineRunner2(ProductRepository productRepository) {
        return args -> {
            ...
            Product product2 = new Product(2L, "banany", 0.2f, 13.30f, 15.0f);
            Product product3 = new Product(3L, "jablka", 0.5f, 13.30f, 5.0f);
            Product product4 = new Product(4L, "jablka", 0.5f, 13.30f, 5.0f);
